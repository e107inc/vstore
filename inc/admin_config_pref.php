...
class vstore_pref_ui extends e_admin_ui
{
	...
	//	protected $listQry      	= "SELECT * FROM #tableName WHERE field != '' "; // Example Custom Query. LEFT JOINS allowed. Should be without any Order or Limit.
		...
		protected $prefs = array(
			...
			'show_outofstock'     		=> array('title'=> 'Show/hide out-of-stock products', 'tab'=>0, 'type' => 'bool', 'help' => 'Show or hide "Out-of-stock" products in product listings', 'writeParms' => array('enabled' => LAN_SHOW, 'disabled' => 'Hide', 'default' => true)),
