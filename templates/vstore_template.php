								                        ...
								                        <div class="panel-body card-body">
								                            ...
								                            <div>
								                                ...
								                                <div class="row">
								                                    ...
								                                    <div class="col-md-7 text-right text-end">{ITEM_ADDTOCART: class=btn btn-sm btn-success vstore-add&class0=btn btn-sm btn-default disabled vstore-add}</div>
								                                </div>
...
$VSTORE_TEMPLATE['item']['main']        = '{SETIMAGE: w=600&h=600}
											<div class="vstore-product-view row">
										        ...
										        <div class="col-md-6">
													...
													<p>
										            '.LAN_VSTORE_CART_001.': {ITEM_CODE}<br />
										            '.LAN_VSTORE_CART_002.': {ITEM_AVAILABILITY}<br /><br />
										            <small class="text-muted">'.LAN_VSTORE_CART_003.'</small>
										            </p>
										            <div class="row">
...
$VSTORE_TEMPLATE['orderconfirm']['main'] = '
		...
		<div class="row">
			<div class="col-12 col-xs-12">
				...
				<button class="btn btn-primary vstore-btn-buy-now pull-right float-right float-end" type="submit" name="mode" value="confirmed">{ORDER_GATEWAY_ICON: size=1x} '.LAN_VSTORE_CUSM_031.'</button>
			</div>
		</div>
		';
...
<tr>
	...
	<th class="text-right text-end">'.LAN_VSTORE_CUSM_023.'</th>
	<th class="text-right text-end">'.LAN_VSTORE_GEN_003.'</th>
	<th class="text-right text-end">'.LAN_VSTORE_CUSM_025.'</th>
</tr>
';
...
<tr>
	<td colspan="3"><b>'.LAN_VSTORE_CART_009.'</b></td>
	<td class="text-right text-end">{CONFIRM_DATA: sub_total}</td>
</tr>
<tr>
	<td colspan="3"><b>'.LAN_VSTORE_CUSM_026.'</b></td>
	<td class="text-right text-end">{CONFIRM_DATA: shipping_total}</td>
</tr>
{CONFIRM_COUPON}
{CONFIRM_TAX}
<tr>
	<td colspan="3"><b>'.LAN_VSTORE_GEN_013.'</b></td>
...
<tr>
	<td colspan="3"><b>'.LAN_VSTORE_CUSM_039.'</b> {CONFIRM_DATA: coupon}</td>
...
<tr>
	<td colspan="2"><b>'.LAN_VSTORE_CUSM_027.'</b></td>
	<td colspan="1" class="text-right text-end">[x]</td>
...
<tr>
	<th>'.LAN_VSTORE_CUSM_022.'</th>
	<th class="text-right text-end">'.LAN_VSTORE_CUSM_023.'</th>
	<th class="text-right text-end">'.LAN_VSTORE_CUSM_024.'</th>
	<th class="text-right text-end">'.LAN_VSTORE_CUSM_025.'</th>
</tr>
';
...
<tr>
	<td colspan="3" class="text-right text-end">'.LAN_VSTORE_CUSM_039.' <b>{CART_DATA: coupon}</b></td>
...
$VSTORE_TEMPLATE['customer']['guest'] = '
	<div class="row">
		<div class="col-12 col-xs-12 col-sm-4">
			<h4>"'.LAN_VSTORE_012.'"</h4>

			<p>"'.LAN_VSTORE_013.'"
			</p>

			<div class="form-group">
				<a class="btn btn-primary btn-block" id="register" href="{SITEURL}signup.php" title="Sign up">'.LAN_VSTORE_018.'</a>
			</div>
		</div>

		<div class="col-12 col-xs-12 col-sm-4">
			<h4>'.LAN_VSTORE_014.'</h4>

			<p>'.LAN_VSTORE_015.'
			</p>

			<div class="form-group">
				<button name="as_guest" class="btn btn-default btn-secondary btn-block" type="submit" value="guest">'.LAN_VSTORE_014.'</button>
			</div>
		</div>
	
		<div class="col-12 col-xs-12 col-sm-4">
			<h4>'.LAN_VSTORE_016.'</h4>
			...
			<div class="form-group">
				<button name="userlogin" class="btn btn-default btn-secondary btn-block" type="submit">'.LAN_VSTORE_019.'</button>
			</div>
			</form>
		</div>
...
$VSTORE_TEMPLATE['navcart']['empty'] = '
		<div id="vstore-cart-dropdown-empty" class="alert alert-info">
			'.LAN_VSTORE_CART_029.'
			<br/>
			<a class="alert-link" href="{CART_DATA: index_url}">'.LAN_VSTORE_CART_030.'</a>
		</div>
		<div>
			<a class="btn btn-block btn-default btn-secondary col-xs-6" href="{CART_DATA: dashboard_url}"><i class="fa fa-tachometer" aria-hidden="true"></i> '.LAN_VSTORE_CART_017.'</a>
		</div>
';
...
$VSTORE_TEMPLATE['navcart']['footer'] = '
				<li class="media" style="font-size: 1.2em;">
					...
					<span class="">'.LAN_VSTORE_CART_009.':</span>
				</li>
			</ul>
        ...
        <div class="d-grid gap-2">
			<a class="btn btn-block btn-danger" href="#" onclick="vstoreCartReset()"><i class="fa fa-trash-o" aria-hidden="true"></i>'.LAN_VSTORE_CART_016.'</a>
			<a class="btn btn-block btn-primary col-xs-6" href="{CART_DATA: cart_url}"><i class="fa fa-shopping-cart" aria-hidden="true"></i>'.LAN_VSTORE_CART_014.'</a>
			<a class="btn btn-block btn-default btn-secondary col-xs-6" href="{CART_DATA: dashboard_url}"><i class="fa fa-tachometer" aria-hidden="true"></i> '.LAN_VSTORE_CART_017.'</a>
		</div>
';
