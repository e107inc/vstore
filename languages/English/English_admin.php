...
//email debug?allowed?
define("LAN_VSTORE_MBUG_001", "No template found or template is empty!");
define("LAN_VSTORE_MBUG_002", "No explicit shop email defined!<br/>Will use siteadmin email!");
define("LAN_VSTORE_MBUG_003", "No explicit shop email name defined!<br/>Will use siteadmin name!");
...
define("LAN_VSTORE_INV_022", "Date format (date only) used on invoices. e.g. 05/02/2018");
